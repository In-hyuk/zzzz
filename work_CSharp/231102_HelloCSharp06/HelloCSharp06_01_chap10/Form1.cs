...
namespace HelloCSharp06_01_chap10
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            products.Add(new Product() { Name = "김", Price = 50, Description = "맛있는 kim" });
            products.Add(new Product() { Name = "감", Price = 10, Description = "맛난 감!" });

            List<Goods> goods = new List<Goods>();
            goods.Add(new Goods() { Name = "양말", Price = 1000, Description = "손흥민이 20년전 신던 양말", InfluencerName = "손흥민" });
            goods.Add(new Goods() { Name = "칫솔", Price = 500, Description = "아들의 방을 청소할 때 쓴 칫솔", InfluencerName = "손웅정" });
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("TestBox2에 값을 확인하세요");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex) // Exception 이 무조건 맨 아래
            {
