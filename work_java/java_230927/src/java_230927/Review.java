...
public class Review {
	public static void main(String[] args) {
		...
		System.out.println("연휴 전날입니당");
		// "연휴 전날입니다" + "\n"
		System.out.printf("이번해 추석은 %d월 %d일 입니다.\n", 9, 29);
		...
		char c = scan.next().charAt(0); // scan.next()로 입력받은 것 중, 0번째 문자만 뽑아와서 c에 저장한다.

		// 아스키코드 : 컴퓨터가 문자 정보를 이해할 수 있또록 특정 숫자-문자를 일대일대응 시킨 약속
		// A : 65, a : 97, 0 : 48
		...
		// toCharArray() : String -> char[] 형 변환하는 함수
